...
async function startHisoka() {
  ...
  console.log(`WhatsApp Version v${version.join(".")}, isLatest: ${isLatest}`);
  console.log(
    color(
      figlet.textSync("SaktiProject-OpenAI", {
        font: "Standard",
  ...
  const client = configConnect({
    ...
    browser: ["SaktiProject-OpenAI", "Safari", "3.0"],
    auth: state,
  });
